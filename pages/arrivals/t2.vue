...
const { pending, data:flights } = await useLazyFetch(`/api/get_arrivals_flights?page=${page.value}&terminal=2`)

async function fetchPrevious() {
  pending.value = true
  let { data:previousFlights } = await useLazyFetch(`/api/get_arrivals_flights?page=${previousPage.value}&terminal=2`)
