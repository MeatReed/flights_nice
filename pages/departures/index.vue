...
const { pending, data:flights } = await useLazyFetch(`${config.public.apiBase}/get_departure_flights?page=${page}`)

async function fetchPrevious() {
  pending.value = true
  let { data:previousFlights } = await useLazyFetch(`${config.public.apiBase}/get_departure_flights?page=${previousPage}`)
