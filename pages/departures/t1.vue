...
const { pending, data:flights } = await useLazyFetch(`/api/get_departures_flights?page=${page.value}&terminal=1`)

async function fetchPrevious() {
  pending.value = true
  let { data:previousFlights } = await useLazyFetch(`/api/get_departures_flights?page=${previousPage.value}&terminal=1`)
